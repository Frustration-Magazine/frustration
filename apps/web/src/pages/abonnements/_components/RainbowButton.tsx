...
export function RainbowButton({ children, className, ...props }: RainbowButtonProps) {
  return (
    <button
      className={cn(
        "text-primary-foreground focus-visible:ring-ring animate-rainbow focus-visible:outline-hidden group relative inline-flex cursor-pointer items-center justify-center rounded-xl border-0 bg-[length:200%] px-4 font-medium transition-colors [background-clip:padding-box,border-box,border-box] [background-origin:border-box] [border:calc(0.08*1rem)_solid_transparent] focus-visible:ring-1 disabled:pointer-events-none disabled:opacity-50",
