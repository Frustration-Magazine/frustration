...
const ChartTooltipContent = React.forwardRef<
  ...
  React.ComponentProps<typeof RechartsPrimitive.Tooltip> &
    React.ComponentProps<"div"> & {
      ...
      xValue?: string;
      formatterXValue?: (value: any) => string;
    }
>(
  (
    {
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      if (xValue) {
        let prefixValue = payload[0].payload?.[xValue];
        if (formatterXValue) prefixValue = formatterXValue(prefixValue);
        return (
